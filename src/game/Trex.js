...
export default class Trex {
  static config = {
    DROP_VELOCITY: -5,
    GRAVITY: 0.6,    // 通过this.jumpVelocity += this.config.GRAVITY * framesElapsed;  使jumpVelocity变化，模拟重力作用
    HEIGHT: 47,
    HEIGHT_DUCK: 25,
    INIITAL_JUMP_VELOCITY: -10,
    MAX_JUMP_HEIGHT: 30,
    MIN_JUMP_HEIGHT: 30,
    SPEED_DROP_COEFFICIENT: 3,    // this.speedDrop 为 true 时，小恐龙下落速度会放大，这里是放大倍数
    SPRITE_WIDTH: 262,
    START_X_POS: 50,
    WIDTH: 44,
    WIDTH_DUCK: 59
